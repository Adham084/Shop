            ...
            <tbody>
                @foreach ($orders as $order)
                    <tr style="vertical-align: middle">
                        ...
                        <td>
                            <a style="float:left;" href="{{ url('/dashboard/categories/edit/' . $order->id) }}" class="mx-2 btn btn-outline-secondary">Edit</a>
                            <form style="float:left;" action="{{ url('/dashboard/categories/delete/' . $order->id) }}" method="POST">
                                @csrf
                                @method('delete')
